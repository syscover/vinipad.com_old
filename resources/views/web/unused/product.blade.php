...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="sys_product-header sys_page-header sys_inner-container clearfix sys_blue">
                ...
                <h1 class="sys_page-header__title sys_white-text">Product</h1>
            </div>
        </div>
        <div class="row">
            <div class="sys_product sys_inner-container clearfix">
                <div class="row">
                            ...
                            <div class="sys_product__form__body clearfix">
                                <form>
                                    ...
                                    <section class="sys_product__form__section">
                                        ...
                                        <div class="sys_product__form__section__subsection">
                                            <h4 class="sys_product__form__section__title">Alquiler de cámara<br>reflex</h4>
                                            <div class="sys_product__form__section__content">
                                                <div class="sys_form__styled-select">
                                                    <select class="sys_form__styled-select__select sys_form__styled-select__select--small">
                                                        <option>0</option>
                                        ...
                                        <div class="sys_product__form__section__subsection">
                                            <h4 class="sys_product__form__section__title">Botella de Champagne<br>+ 2 copas</h4>
                                            <div class="sys_product__form__section__content">
                                                <div class="sys_form__styled-select">
                                                    <select class="sys_form__styled-select__select sys_form__styled-select__select--small">
                                                        <option>0</option>
                                        ...
                                        <div class="sys_product__form__section__subsection">
                                            <h4 class="sys_product__form__section__title">Caramelos (250 gr.)</h4>
                                            <div class="sys_product__form__section__content">
                                                <div class="sys_form__styled-select">
                                                    <select class="sys_form__styled-select__select sys_form__styled-select__select--small">
                                                        <option>0</option>
                                        ...
                                        <div class="sys_product__form__section__subsection">
                                            <h4 class="sys_product__form__section__title">Patatas fritas</h4>
                                            <div class="sys_product__form__section__content">
                                                <div class="sys_form__styled-select">
                                                    <select class="sys_form__styled-select__select sys_form__styled-select__select--small">
                                                        <option>0</option>
                                        ...
                                        <div class="sys_product__form__section__subsection">
                                            <h4 class="sys_product__form__section__title">Rosas</h4>
                                            <div class="sys_product__form__section__content">
                                                <div class="sys_form__styled-select">
                                                    <select class="sys_form__styled-select__select sys_form__styled-select__select--small">
                                                        <option>0</option>
                                        ...
                                        <div class="sys_product__form__section__subsection">
                                            <h4 class="sys_product__form__section__title">Cuaderno para pintar</h4>
                                            <div class="sys_product__form__section__content">
                                                <div class="sys_form__styled-select">
                                                    <select class="sys_form__styled-select__select sys_form__styled-select__select--small">
                                                        <option>0</option>
                                    ...
                                    <section class="sys_product__form__section">
                                        ...
                                        <br>
                                        <h3 class="sys_product__form__section__title sys_product__form__section__title--apart">Hora</h3>
                                        <div class="sys_product__form__section__content sys_product__form__section__content--apart">
                                    ...
                                    <section class="sys_product__form__section">
                                        <div class="sys_product__form__section__content sys_product__form__section__content--apart">
                                            <a href="" class="sys_button sys_button--full-width sys_button--red">
                                                Lorem ipsum
                                            </a>
                                        </div>
                                    </section>
